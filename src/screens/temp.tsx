...
export function OrderDetailsScreen({
  ...
  // Loading and update timestamp states
  ...
  // Initial fetch to ensure data freshness
  useEffect(() => {
    const fetchOrder = async () => {
      ...
      .eq("userId", user.id)
        .maybeSingle();
      if (data) {
        // Ensure orderItems defaults to an empty array if undefined
      ...
      .on(
        ...
        (payload) => {
          setCurrentOrder((prev) => ({
            ...
            // If orderItems is undefined in the payload, fallback to previous value
